...
export default function EcommerceDetailPage() {
  ...
  const product = {
    ...
    description:
      "A scalable online store with secure payments, inventory management, order tracking, and business analytics.",
    category: "Commerce",
    image: "/products/ecommerce.png",

    webUI: [
      "/products/shop/ecommerce-web-1.png",
    ],
    mobileUI: [
      "/products/shop/ecommerce-mobile-1.png",
      "/products/shop/ecommerce-mobile-2.png",
      "/products/shop/ecommerce-mobile-3.png",
      "/products/shop/ecommerce-mobile-4.png"
    ],
